...
// @version      2025-06-18
// @description  Waits for Language Reactor panel to load, then removes <br> tags from subtitles, so that when using yomitan can pick up full sentence when scaning the subtitle inside video.
